...
function App() {
  ...
  return (
    <div className="container">
      ...
      <Section icon={champagnesIcon} time="18:00" title="Հարսանյաց Հանդիսություն" locationName="Մորենա ռեստորանային համալիր" img={restaurantImg} address="Հասցեն՝ Մասիս, Մխիթար Հերացու փող., 7/8" locationLink="https://yandex.com/maps/org/222913353582/?ll=44.444778%2C40.059849&z=16.77"/>
